...
<option value="zw">Zimbabwe</option>
            ...
            <Link
              to="/signup"
              className="w-full bg-[#DC2626] hover:bg-red-600 text-white font-semibold py-2 px-6 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2 shadow-sm"
            >
