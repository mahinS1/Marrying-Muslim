...
export const PersonalInfoStep: React.FC<PersonalInfoStepProps> = ({
  ...
  // ✅ DOB validation dates (calculated once here)
  ...
  const minDobStr = hundredYearsAgo.toISOString().split("T")[0];
  ...
  <input
    ...
    className="w-full p-2 bg-gray-50 border border-gray-200 rounded-lg 
               ...
               focus:border-red-300 focus:ring-1 focus:ring-red-200 transition-colors"
  />
</FormField>
      ...
      <FormField label="About Me" required error={showErrors ? errors.aboutMe : undefined}>
        <textarea
          ...
          placeholder="We refrain from allowing detailed descriptions of women or men..."
          rows={3}
